...
// ===== [ تحسين الأداء بتمكين Caching للملفات الثابتة ] =====
app.use(express.static(path.join(__dirname, '../assets'), {
  maxAge: '1d', // تكوين مدة التخزين المؤقت للملفات الثابتة
  etag: false // تعطيل ETag إذا كان لا حاجة له
}));
...
app.use((req, res, next) => {
    res.status(404).send(`
        <div style="font-family: Arial, sans-serif; text-align: center; margin-top: 50px;">
            ...
            <p style="color: #333;">عذرًا، الصفحة التي تبحث عنها غير موجودة! يمكنك العودة إلى <a href="/">الصفحة الرئيسية</a>.</p>
        </div>
    `);
});
